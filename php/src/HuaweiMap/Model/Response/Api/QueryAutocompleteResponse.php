...
use HuaweiMap\Model\Response\AutocompletePrediction;
use HuaweiMap\Model\Response\Site;
use HuaweiMap\Utils;

class QueryAutocompleteResponse extends SiteResponse
{
    /**
     * @var Site[] Autocomplete result.
     */
    private $sites;
    /**
     * @var AutocompletePrediction[]
     */
    private $predictions;

    public function __construct($returnCode, $returnDesc, $sites, $predictions)
    {
    ...
    public static function toObject($json)
    {
        ...
        return new self(
                ...
                AutocompletePrediction::toObjectArray(Utils::getValue($json, "predictions"))
        );
    }
