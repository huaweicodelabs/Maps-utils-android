...
public class ReverseGeocodeRequestClient: BaseRequestClient {
    static let shared = ReverseGeocodeRequestClient()
    /**
     * reverseGeocode
     */
    private var _request: ReverseGeocodeRequest?
    ...
    public override func requestMode() -> RequestMode {
        return ApiInfoConstants.ApiCall.reverseGeocode.requestMode
    }
    ...
    override public func createBodyParameters() -> [String: Any] {
        ...
        if let returnPoi = request.returnPoi{
            params["returnPoi"] = returnPoi
        }
    ...
    public override func path() -> String {
        return ApiInfoConstants.ApiCall.reverseGeocode.link
    }
